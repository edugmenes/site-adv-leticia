  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
        {/* Large rotated rectangle — decorative gold accent */}
        ...
        <div className="grid md:grid-cols-12 gap-12 items-center">
          ...
          <div className="md:col-span-7 space-y-8">
            ...
            <div className="flex items-center gap-4 animate-fade-up" style={{ opacity: 0 }}>
              ...
              <span className="section-label">Direito do Trabalho e Processo do Trabalho</span>
            </div>

            {/* Headline */}
            <h1
              className="font-display text-4xl sm:text-5xl md:text-6xl leading-[1.08] font-medium text-charcoal-50 text-balance animate-fade-up animate-delay-100"
              style={{ opacity: 0 }}
            >
              Seus direitos <br />
            ...
            {/* Subtext */}
            <p
              className="font-body text-lg md:text-xl text-charcoal-300 leading-relaxed max-w-xl animate-fade-up animate-delay-200"
              style={{ opacity: 0 }}
            >
            ...
            >
              <a
                href="https://wa.me/5511999999999?text=Olá!%20Gostaria%20de%20agendar%20uma%20consulta%20trabalhista."
                target="_blank"
            ...
            {/* Trust bar */}
            <div
              className="pt-4 border-t border-charcoal-800 flex flex-wrap gap-6 animate-fade-up animate-delay-400"
              style={{ opacity: 0 }}
            >
              {[
      ...
      <div
        className="absolute bottom-0 left-0 right-0 h-24 bg-gradient-to-t from-charcoal-950 to-transparent pointer-events-none"
        aria-hidden="true"
      />
    </section>
  )
...
function ScaleIcon() {
  return (
    <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#B3852D" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      <path d="M12 3L3 7l1.5 8.5L12 21l7.5-5.5L21 7z" />
      <path d="M12 3v18M3 7h18" />
      <path d="M6.5 7l-2 8M17.5 7l2 8" />
    </svg>
  )
}
