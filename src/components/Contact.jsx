  ...
  export default function Contact() {
    ...
    const validateForm = () => {
      ...
      if (!form.nome.trim()) {
        ...
        newErrors.nome = 'O nome não deve conter números ou caracteres especiais.'
      }

      if (!form.email.trim()) {
        newErrors.email = 'Informe seu e-mail.'
      } else if (!emailRegex.test(form.email)) {
        newErrors.email = 'Informe um e-mail válido. Exemplo: nome@email.com'
      }

      if (!form.mensagem.trim()) {
        newErrors.mensagem = 'Digite sua mensagem.'
      } else if (form.mensagem.length > 150) {
        newErrors.mensagem = 'A mensagem deve ter no máximo 150 caracteres.'
      }
                ...
                {sent ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6" noValidate>
                    ...
                    <div className="space-y-2">
                      <label
                        htmlFor="mensagem"
                        className="font-sans text-xs text-navy-500 tracking-wide uppercase"
                      >
                      ...
                      <div className="flex justify-between gap-4">
                        {errors.mensagem ? (
                          <p id="mensagem-error" className="font-sans text-xs text-red-600">
                            {errors.mensagem}
                          </p>
                        ) : (
                          <span />
                    ...
                    <div className="flex flex-col min-[460px]:flex-row min-[460px]:items-center min-[460px]:justify-between gap-4 pt-2">
  ...
  function PhoneIcon() {
    return (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
        <path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 10.8 19.79 19.79 0 01.07 2.18 2 2 0 012.09 0h3a2 2 0 012 1.72c.127.96.361 1.903.7 2.81a2 2 0 01-.45 2.11L6.91 7.91a16 16 0 006.06 6.06l1.27-1.27a2 2 0 012.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0122 16.92z" />
      </svg>
    )
  }
